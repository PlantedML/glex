...
augmentTree <- function(tree, dataset) {
    .Call(`_glex_augmentTree`, tree, dataset)
}

augmentAndTakeExpectation <- function(x, dataset, tree, to_explain) {
    .Call(`_glex_augmentAndTakeExpectation`, x, dataset, tree, to_explain)
}
