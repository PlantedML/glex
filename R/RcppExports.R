...
contribute_fastpd2 <- function(mat, m_all, S, T_subsets, colnum) {
    invisible(.Call(`_glex_contribute_fastpd2`, mat, m_all, S, T_subsets, colnum))
}

augmentAndTakeExpectation <- function(x, dataset, tree, to_explain, is_weak_inequality) {
    .Call(`_glex_augmentAndTakeExpectation`, x, dataset, tree, to_explain, is_weak_inequality)
}

augmentTree <- function(tree, dataset, is_weak_inequality) {
    .Call(`_glex_augmentTree`, tree, dataset, is_weak_inequality)
}

augmentExpectation <- function(x, tree, to_explain, leaf_data_ptr, is_weak_inequality) {
    .Call(`_glex_augmentExpectation`, x, tree, to_explain, leaf_data_ptr, is_weak_inequality)
}

marginalizeAllSplittedSubsetsinTree <- function(x, tree, is_weak_inequality) {
    .Call(`_glex_marginalizeAllSplittedSubsetsinTree`, x, tree, is_weak_inequality)
}

explainTreeFastPD <- function(x, tree, to_explain_list, max_interaction, is_weak_inequality) {
    .Call(`_glex_explainTreeFastPD`, x, tree, to_explain_list, max_interaction, is_weak_inequality)
}

explainTreeFastPDBitmask <- function(x, x_background, tree, to_explain_list, max_interaction, is_weak_inequality) {
    .Call(`_glex_explainTreeFastPDBitmask`, x, x_background, tree, to_explain_list, max_interaction, is_weak_inequality)
}
