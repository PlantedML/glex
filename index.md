...
`glex` calculates **functional decompositions** of tree-based regression
and classification models that decomposes them into **main effects** and
**interaction effects** of arbitrary order. Those **functional
components** can thereafter be used to
...
![](reference/figures/README-glex_vi-plot-1.png)
...
![](reference/figures/README-glex_vi-plot-by-degree-1.png)
...
![](reference/figures/README-plot_components-2.png)
...
![](reference/figures/README-main_pdp-1.png)
...
![](reference/figures/README-glex_explain-1.png)
